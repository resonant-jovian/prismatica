...
pub fn generate_discrete_palette_rs(palette: &PaletteData, const_name: &str) -> String {
    ...
    out.push_str("// Auto-generated by prismatica xtask -- do not edit\n");
    out.push_str("use crate::{DiscretePalette, ColormapMeta, ColormapKind};\n\n");
    ...
    out.push_str("    },\n");
    out.push_str(&format!(
        "    colors: &{const_name}_PALETTE_COLORS,\n"
    ));
    out.push_str("};\n\n");
...
pub fn generate_dual_colormap_rs(
    ...
    out.push_str("// Auto-generated by prismatica xtask -- do not edit\n");
    out.push_str("use crate::{Colormap, DiscretePalette, ColormapMeta, ColormapKind};\n\n");
    ...
    out.push_str(&format!(
        "/// Original {}-color discrete palette.\n",
        n
    ));
    out.push_str(&format!(
        "pub const {const_name}_PALETTE: DiscretePalette = DiscretePalette {{\n"
